...
public class ProdutoTela extends javax.swing.JDialog {
    ...
    public void montaTabela() {
        ...
        for (Produto e : lista) {
            modelo.addRow(new Object[]{e.getId(), e.getNome(), e.getEstoque(), e.getPreco()});
        }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(cEstoque, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(jLabel5)
                                .addGap(18, 18, 18)
                                .addComponent(cPreco, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        if (validaCampos()) {
            ...
            prod.setEstoque(Double.parseDouble(cEstoque.getText()));
            prod.setPreco(Double.parseDouble(cPreco.getText().replace(".", "").replace(",", ".")));
...
//        System.exit(1);
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        cId.setText(prod.getId().toString());
        cNome.setText(prod.getNome());
        cEstoque.setText(prod.getEstoque().toString());
        cPreco.setText(prod.getPreco().toString());
